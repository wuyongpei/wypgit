...
<body>
	<!-- 分成二级科室 -->
	<div style="height: 100%;background: #EFEFF4;overflow: hidden;">
		...
		<div id="dediv">	
			<div class="weui-cells" style="margin-top: 0;border-bottom: 1px solid #e5e5e5;">
			...
			<div style="display: inline-block;width: 100%;">
				<div id="left-container" class="container" style="width: 100%;float: left;">
					<div class="weui-cells" style="margin-top: 0;width: 100%;height: 100%;overflow-y:auto;overflow-x:hidden;  ">
						<!-- 						<a href="javascript:selectSection();" class="weui-cell weui-cell_access">
							<div class="weui-cell__bd">
								<p>小儿内科</p>
							</div>
							<div class="weui-cell__ft"></div>
						...
						<a href="javascript:;" class="weui-cell weui-cell_access" onclick="selectSection('${deplist.OfficeID }',this);return false;">
							<div class="weui-cell__bd">
				...
				<!-- 子科室类别 -->
				<div id="right-container" class="container" style="width: 50%;float: right;">
					<div class="weui-cells" style="margin-top: 0;width: 100%;height: 100%;overflow-y:auto;overflow-x:hidden;background: #F5F5F5; ">
		...
		<div class="container" style="width: 100%;height: 100%;overflow-y:auto;overflow-x:hidden; ">
			
			<!-- 搜索结果  科室信息 -->
			<div id="searchDepResult" class="hidediv" style="margin-top: -23px;">
				<div class="weui-cells">	
	<!-- 				<a class="weui-cell weui-cell_access">
						<div class="weui-cell__bd"><p>心血管内科</p></div>
						<div class="weui-cell__ft"></div>
					</a> -->
				</div>
			</div>
			...
			<div id="searchDocResult" class="hidediv" style="margin-top: -21px;">
 				<div class="weui-cells">
<!--	 				<div class="weui-cell__bd" style="padding: 5px 0px 5px 15px;color: #999999;font-size: 12px;">医生信息&nbsp;(&nbsp;3&nbsp;)</div>
							...
							<a href="javascript:void(0);" class="weui-media-box weui-media-box_appmsg" style="border-bottom: 1px solid #F5F5F5;padding: 0 10px 5px 10px;height: auto;">
								...
								<div style="text-align: left;width: 100%;position: relative;padding-top: 5px;">	
									<div class="weui-laber" style="line-height: 1.7em;float: left;width: 75%;">
										<div id="doctorname" class="weui-media-box__title" style="float: left;font-weight: bold;font-size: 14px;">林荣&nbsp;</div>
										<label class="weui-laber" style="color: #808080;margin-left: 10px;font-size: 12px;">主任医师&nbsp;</label><br>
										<div class="weui-laber" style="color: #808080;text-align: left;font-size: 12px;">&nbsp;诊查费:&nbsp;￥20.00</div>
									</div>
...
<script type="text/javascript">
					...
					if(deplist!="" && deplist!=null || emplist!="" && emplist!=null){
						...
						if(deplist!="" && deplist!=null){
							...
							for(var i=0;i<deplist.length;i++){
								$("#searchDepResult div.weui-cells").append(
									"<a href='weixin/selectDoctor2/"+deplist[i].WorkPositionID+"' class='weui-cell weui-cell_access'>"
									+"<div class='weui-cell__bd'><p>"+deplist[i].WorkPositionName+"</p>"
									+"</div>"
									+"<div class='weui-cell__ft'></div> "
									+"</a>"
								);
						...
						if(emplist!="" && emplist!=null){
							...
							for(var i=0;i<emplist.length;i++){	
								$("#searchDocResult div.weui-cells").append(
										...
										+"<div class='weui-laber' style='color: #808080;text-align: left;font-size: 12px;'>&nbsp;医生类别:&nbsp;"+emplist[i].Doctor_Type+"</div>"
										+"</div>"
	...
	//选择科室   二级科室
	function selectSection(officeID,e){
		$("#left-container").css('width','50%');
		var cla= $(e).attr('class');
		if(cla=="weui-cell weui-cell_access"){
			$('#left-container a').removeClass('background');
			$(e).addClass('background');
		}
		//加载对应二级科室
		$.post("weixin/load/page/department",{officeID:officeID},function(data){
			$("#right-container div.weui-cells").empty();
			var deplist=data.depsonlist;
			if(deplist!="" && deplist!=null){
				for(var i=0;i<deplist.length;i++){
					$("#right-container div.weui-cells").append(
						"<a href='weixin/selectDoctor2/"+deplist[i].WorkPositionID+"' class='weui-cell weui-cell_access' >"		
						+"<div class='weui-cell__bd'>"
						+"<p>"+deplist[i].WorkPositionName+"</p>"
						+"</div>"
						+"</a>"
					);
				}
