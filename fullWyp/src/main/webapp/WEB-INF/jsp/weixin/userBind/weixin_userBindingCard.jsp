...
<body>
	...
	<!--  			<div class="weui-cell">
				...
				<div class="weui-cell">
					...
					<div class="weui-cell__bd">
						<input id="medicalCard"  name="medicalCard"  class="weui-input" type="text" placeholder="请输入就诊卡号">
					</div>
				</div>-->
				<div class="weui-cell">
...
<script type="text/javascript">
	...
	function bindMedicalCard(){
		...
		if(patientName==null || patientName==""){
		...
		}else if(medicalCard==null || medicalCard==""){
			$.toast("就诊卡号不能为空","forbidden");
            ...
            $.ajax({
				  url:"weixin/bind/card",
         		  type: 'POST',
         	      data: {
      				patientName:patientName,medicalCard:medicalCard,
         		  ...
         		  success:function(result){
    				...
    				}else if(result.statue=="cardExist"){//被占用
