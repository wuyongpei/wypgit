...
<body>
			...
			<div class="modal-content">
				<form id="dic-form" method="post">
					...
					<div class="modal-body">
						<input type="hidden" id="patientID" name="patientID" value="${DictionaryID }">
						<div class="form-group">
							<label >字典类别</label>
							<input class="form-control" type="text" readonly="readonly" value="${DictionaryName }">
						</div>
						<div class="form-group">
							<label >字典编码</label>
						...
						<div class="form-group">
							<label >字典名称</label>
							<input class="form-control" type="text" placeholder="输入字典名称" name="dictionaryName" id="dictionaryName-add" onchange="getPinYin();">
						</div>
						<div class="form-group">
							<label >字典简拼</label>
	...
	//获取简拼
	function getPinYin(){
		var dicname=$("#dictionaryName-add").val();
