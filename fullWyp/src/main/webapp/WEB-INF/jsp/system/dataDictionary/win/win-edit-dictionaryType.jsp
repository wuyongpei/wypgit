			...
			<div class="modal-content">
				<form id="dic-form" method="get">
					<div class="modal-header">
						...
						<h4 class="modal-title">编辑字典类别</h4>
					</div>
					<div class="modal-body">
						...
						<div class="form-group">
							<label >字典名称</label>
							<input class="form-control" type="text" placeholder="输入字典名称" name="dictionaryName" id="dictypeName" onchange="getPinYin();" value="${dic.DictionaryName }">
						</div>
						<div class="form-group">
							<label >字典简拼</label>
