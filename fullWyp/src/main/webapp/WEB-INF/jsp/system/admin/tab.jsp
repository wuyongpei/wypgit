...
<script type="text/javascript" src="static/login/js/jquery-1.7.2.js"></script>
<script type="text/javascript" src="static/plugins/tab/js/framework.js"></script>
<link href="static/plugins/tab/css/import_basic.css" rel="stylesheet"
	type="text/css" />
<link rel="stylesheet" type="text/css" id="skin"
	prePath="static/plugins/tab/" />
<!--默认相对于根目录路径为../，可添加prePath属性自定义相对路径，如prePath="<%=request.getContextPath()%>"-->
<script type="text/javascript" charset="utf-8"
	src="static/plugins/tab/js/tab.js"></script>
</head>
